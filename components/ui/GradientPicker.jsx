// use less code, I tried using shadcn Gradient picker for colour picking which has much better UI.
// will do it some time after
'use client'
...
export function GradientPicker({ background, setBackground, className }) {
    ...
    const images = [
        'url(https://images.unsplash.com/photo-1691200099282-16fd34790ade?auto=format&fit=crop&w=2532&q=90)',
        'url(https://images.unsplash.com/photo-1691226099773-b13a89a1d167?auto=format&fit=crop&w=2532&q=90)',
        'url(https://images.unsplash.com/photo-1688822863426-8c5f9b257090?auto=format&fit=crop&w=2532&q=90)',
        'url(https://images.unsplash.com/photo-1691225850735-6e4e51834cad?auto=format&fit=crop&w=2532&q=90)',
    ]
