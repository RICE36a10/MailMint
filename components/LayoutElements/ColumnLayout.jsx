...
import {useDragDropLayout, useEmailTemplate, useSelectedElement} from "@/app/provider";
...
export function ColumnLayout({layout}) {
    ...
    const ondragoverhandle = (event, index) => {
        ...
        setDragOver({
            index: index, columnId: layout?.id,
        })
    }
    ...
    const ondrophandle = () => {
        ...
        setEmailTemplate((prevItem) => prevItem?.map((col) => col.id === layout?.id ? {
